...
// select for the event, list and do something (which is a function)
...
// theBox.addEventListener('click', moveBox, false);

// var num = 1;

// $('#the-button').click(function(){
//     //do this when the button is pressed
//     var theText = 'You pressed me ' + num + ' times.'; 
//     $('#the-div').html(theText);
//     num = num + 1;
// });
